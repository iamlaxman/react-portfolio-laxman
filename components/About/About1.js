      ...
      >
        ...
        >
          <span className="about-1 leading-tight">
            I&apos;m a passionate ethical hacker, UI/UX developer, and software developer who&apos;s focused on building
            secure, scalable and performant apps.{" "}
          </span>
          <span className="about-2 leading-tight">
            I take responsibility to craft a good user experience using modern
            frontend architecture while ensuring robust security practices.{" "}
          </span>
        </h1>
      </div>
    </section>
